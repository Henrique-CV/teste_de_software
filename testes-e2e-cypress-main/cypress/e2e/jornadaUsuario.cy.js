describe('Jornadas de usuário', () => {
    ...
    cy.getByData('select-opcoes').select('Transferência') /* no formulário, 'select-opcoes' é o campo onde selecionamos qual tipo de transação. Escolhemos 'Transferência' */
